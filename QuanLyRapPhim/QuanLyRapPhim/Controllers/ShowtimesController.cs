...
namespace QuanLyRapPhim.Controllers
{
    public class ShowtimesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ShowtimeId,MovieId,Poster,StartTime,Date")] Showtime showtime)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ShowtimeId,MovieId,Poster,StartTime,Date")] Showtime showtime)
        {
